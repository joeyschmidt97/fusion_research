...
from key_list_for_file_dicts import nrg_key_list

os.chdir("./parameters_data")
from GP_parameters_data_V4 import species_list, parameters_filepath_to_dict
    ...
    for item in input_list:
        ...
        for tup in input_tuple:
            if item == tup[0]:
                ...
                break
        if not found:
            raise ValueError(f"'{item}' not found in the tuple: {input_tuple}")
    return tuple(result)
